...
ytdEntry = Entry(root,width=30,textvariable=ytdEntryVar)
ytdEntry.grid()
...
#btn of save file
saveEntry = Button(root,width=10,bg="green",fg="black",text="Choose Path",command=openLocation)
saveEntry.grid()
...
#donwload btn
downloadbtn = Button(root,text="Donwload",width=10,bg="green",fg="black",command=DownloadVideo)
downloadbtn.grid()
